...
- **AZ-04** — `GET /health` devolve HTTP 200 quando o banco está disponível e informa o estado da conexão.
- **AZ-05** — uma página servida pelo backend carrega e mostra o resultado de `GET /health`.
